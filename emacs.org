...
#+begin_src emacs-lisp
  ...
  (setq org-publish-project-alist
        '(("aphorisms"
           ...
           :section-numbers nil)))
#+end_src
*** TODO stop it from publishing a table of contents
looks like ~table-of-contents nil~ doesn't do anything here. Make it stop.

** Capture templates
#+begin_src emacs-lisp
  (global-set-key (kbd "C-c c") 'org-capture)
  (setq org-capture-templates
        '(("b" "Blog" entry (file+headline "~/aphorisms/org/inbox.org" "Inbox")
           "* TITLE\n#+TITLE:\n#+DATE: %t\n#+JEKYLL_CATEGORIES:\n#+JEKYLL_LAYOUT: post\n\n%?")))
#+end_src

*** TODO Change the destination here to ~\~/org/index.org~ and a specific subheading
