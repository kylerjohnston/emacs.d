...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (lsp-ivy company-lsp lsp-ui lsp-mode flycheck which-key flymake-shell flymake-shellcheck elpy company-ansible ansible rubocop robe inf-ruby company-graphviz-dot graphviz-dot-mode evil-magit counsel diminish terraform-doc doom-themes org-plus-contrib use-package))))
(custom-set-faces
